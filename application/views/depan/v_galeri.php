            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        <img src="<?php echo base_url() . 'assets/images/' . $row->galeri_gambar; ?>" class="img-fluid"
                            alt="">
                        ...
                        <div class="portfolio-info">
                            ...
                            <div>
                                <a href="<?php echo base_url() . 'assets/images/' . $row->galeri_gambar; ?>"
                                    data-lightbox="portfolio" data-title="<?php echo $row->galeri_judul; ?>"
                                    class="link-preview" title="Preview"><i class="ion ion-ios-eye"></i></a>
