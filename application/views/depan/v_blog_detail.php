                ...
                <div class="col-md-8">
                    ...
                    <div class="blog-tiltle_block">
                        ...
                        <h6> <a href="#"><i class="fa fa-user"
                                    aria-hidden="true"></i><span><?php echo $author; ?></span> </a> | <a href="#"><i
                                    class="fa fa-tags" aria-hidden="true"></i><span><?php echo $kategori; ?></span></a>
                        </h6>
                        <?php echo $blog; ?>
                    </div>
                    ...
                    <div class="blog-tiltle_block">
                        ...
                        <ul class="nav nav-tabs blogpost-tab-wrap" role="tablist">
                            ...
                            <li class="nav-item blogpost-nav-tab" style="font-weight: 600;">
                                <a class="nav-link" data-toggle="tab" href="#write-comment" role="tab"
                                    style="color:black;">Leave a comment</a>
                            </li>
                        </ul>
                        ...
                        <div class="blogpost-tabs">
                            ...
                            <div class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="blodpost-tab-img"
                                                        style="background-color:<?php echo reset($colors); ?>;width: 65px;height: 65px;">
                                                        <center>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 offset-md-1">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="blodpost-tab-img"
                                                        style="background-color:<?php echo reset($colors); ?>;width: 65px;height: 65px;border-radius: 40px 40px 40px 0px;">
                                                        <center>
                                                            <h2 style="padding-top:20%;">
                                ...
                                <div class="form-comments tab-pane" id="write-comment" role="tabpanel">
                                    <form class="form-a" action="<?php echo site_url('blog/komentar'); ?>"
                                        method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="textMessage" name="komentar" class="form-control"
                ...
                <div class=" col-md-4">
                    ...
                    <div class="blog-featured_post">
                        ...
                        <div class="blog-featured-img_block">
                            ...
                            <h5><a
                                    href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>"><?php echo character_limiter($row->tulisan_judul, 40); ?></a>
                            </h5>
