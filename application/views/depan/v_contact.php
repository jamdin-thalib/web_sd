                ...
                <div class="col-sm-12">
                    <div class="contact-map box">
                        <div id="map" class="contact-map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1977.6487907497951!2d110.922237!3d-7.54249!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xa7c9505adc5ec1ee!2sSDN%2003%20Macanan!5e0!3m2!1sid!2sid!4v1574168539408!5m2!1sid!2sid" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="contact-option_rsp">
                                <form action="<?php echo site_url('contact/kirim_pesan'); ?>" method="post" class="form-a">
								...
								<div id="errormessage"></div> -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <input type="text" placeholder="Name" name="xnama" class="form-control form-control-lg form-control-a" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required>
                                                <!-- <div class="validation"></div> -->
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <input type="email" name="xemail" class="form-control form-control-lg form-control-a" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" required>
                                                <!-- <div class="validation"></div> -->
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <div class="form-group">
                                                <input type="text" name="xphone" class="form-control form-control-lg form-control-a" placeholder="Phone" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                                                <!-- <div class="validation"></div> -->
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <div class="form-group">
                                                <textarea placeholder="Message" class="form-control" name="xmessage" data-msg="Please write something for us" required rows="5"></textarea>
                                                <!-- <div class="validation"></div> -->
                                            </div>
                                        </div>
                                        <div class="col-md-12">
